...
--
-- Host: localhost
-- Generation Time: Sep 06, 2022 at 04:39 AM
...
--
-- Table structure for table `sowing_farm_land_planning`
--

CREATE TABLE `sowing_farm_land_planning` (
  `id` bigint(20) NOT NULL,
  `farmer_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `sowing_farm_land_planning_crop`
--

CREATE TABLE `sowing_farm_land_planning_crop` (
  `id` bigint(20) NOT NULL,
...
--
-- Indexes for table `sowing_farm_land_planning`
--
ALTER TABLE `sowing_farm_land_planning`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sowing_farm_land_planning_crop`
--
ALTER TABLE `sowing_farm_land_planning_crop`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `sowing_farm_land_planning`
--
ALTER TABLE `sowing_farm_land_planning`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sowing_farm_land_planning_crop`
--
ALTER TABLE `sowing_farm_land_planning_crop`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `sowing_farm_land_planning`
--
ALTER TABLE `sowing_farm_land_planning`
...
--
-- Constraints for table `sowing_farm_land_planning_crop`
--
ALTER TABLE `sowing_farm_land_planning_crop`
  ...
  ADD CONSTRAINT `planning_crop_farmland_fk` FOREIGN KEY (`farm_land_planning_id`) REFERENCES `sowing_farm_land_planning` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
