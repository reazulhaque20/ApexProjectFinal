app.controller('locationCtrl', function (serverURL, uiURL, $scope, $http, NgTableParams, $window, SweetAlert) {
    ...
    $scope.addLocation = function (loc) {
        ...
        $http.post($scope.urlServer + "api/location/addLocation", loc, config).then(
            function (response) {
                console.log(response);
                switch (response.data.messageType) {
                    case 'success':
                        $scope.message("SUCCESS", response.data.message, "success");
                        $("#addOrEditLocation").modal("hide");
                        $scope.loadAllLocations();
                        break;
                    case 'error':
    ...
    $scope.updateLocation = function (loc) {
        ...
        $http.post($scope.urlServer + "api/location/updateLocation", loc, config).then(
            function (response) {
                console.log(response);
                switch (response.data.messageType) {
                    case 'success':
