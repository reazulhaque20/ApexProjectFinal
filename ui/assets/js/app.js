!(function (a) {
    ...
    a("#side-menu").metisMenu(),
        ...
        a(document).on("click", "body", function (t) {
            0 < a(t.target).closest(".right-bar-toggle, .requisition_logs, .logs-bar-toggle, .right-bar, .logs-bar").length || a("body").removeClass("logs-bar-enabled, right-bar-enabled");
        }),
