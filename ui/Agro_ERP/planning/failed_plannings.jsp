                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Failed Planning List</h4>
                                </div>
                                <div class="card-body">
                                    <table id="failed-planning-details-list" class="table cus-datatable table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>LAND ID</th>
                                                <th>CONT ID</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>01700000000</td>
                                                <td><span class="badge badge-soft-danger">SOWING</span></td>
                                                <td>25 APR 2022</td>
                                                <td class=" dt-body-center">
                                                    <button class="btn btn-soft-primary btn-sm" onclick="addFarmlandSeasonalPlanning('120')"><i class="mdi mdi-lightbulb-on-outline"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    <script>
        $(document).ready(function () {
            document.title = "Failed Planning Details List-";
            
            $("#failed-planning-details-list").DataTable({
                responsive: true,
                stateSave: true,
                ordering: false,
                pageLength: 15,
