    ...
    <%@include file="../header.jsp" %>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Planning Pending Farmland List</h4>
                                </div>
                                <div class="card-body">
                                    <table id="pending-planning-details-list" class="table cus-datatable table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>LAND ID</th>
                                                <th>CONT ID</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>CNT00001</td>
                                                <td>10 DEC</td>
                                                <td>Address of the Land with GPS Location</td>
                                                ...
                                                <td class=" dt-body-center">
                                                    <button class="btn btn-soft-primary btn-sm" onclick="addFarmlandSeasonalPlanning('120')"><i class="mdi mdi-plus-circle-outline"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <div id="addNewFarmlandPlanningDetails" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myExtraLargeModalLabel">Add Farmland Planning Details</h5>
                    ...
                    <form class="modal-body" id="AddNewProjectMasterDetails" method="POST" action="PdmController">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <label class="form-label">APPROX SOWING DATE</label>
                                <input class="form-control" type="date" name="district_name" value="" required>
                            </div>
                            <div class="col-lg-12 mb-2">
                                <label class="form-label">APPROX HARVEST DATE</label>
                                <input class="form-control" type="date" name="district_name" value="" required>
                            </div>
                            <div class="col-lg-12 mb-2">
                                <label class="form-label">EXPECTED YIELD/DECIMAL</label>
                                <input class="form-control float" type="text" name="district_name" value="" required>
                            </div>
                            <div class="col-lg-12 mb-2">
                                <label class="form-label">EXPECTED PURCHASE QTY</label>
                                <input class="form-control float" type="text" name="district_name" value="" required>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        $(document).ready(function () {
            document.title = "Pending Planning Details List-";
            
            $("#pending-planning-details-list").DataTable({
                responsive: true,
                stateSave: true,
                ordering: false,
                pageLength: 15,
