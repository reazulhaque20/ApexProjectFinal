    ...
    <%@include file="../header.jsp" %>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Buyer Master Details List</h4>
                                </div>
                                <div class="card-body">
                                    <table id="buyer-list-details" class="table cus-datatable table-striped dt-responsive w-100">
                                        <thead>
                                            <tr>
                                                <th width="4%">CODE</th>
        ...
        <div class="modal fade" id="addNewBuyerDetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Add New Buyer Details</h5>
                    ...
                    <form class="modal-body row" id="AddNewSupplierDetails" method="POST" action="PdmController">   
                        ...
                        <div class="col-md-12">
                            <div class="col-lg-12 mb-2 select2-sm">
                                <label class="form-label label-sm">BUYER CODE</label>
                                <input class="form-control input-sm" type="text" name="buyer_code" value="001" required readonly>
                            </div>
                            <div class="col-lg-12 mb-2 select2-sm">
                            ...
                            <div class="col-lg-12 mb-2">
                                <label class="form-label label-sm">BUYER FULL NAME</label>
        ...
        <div class="modal fade" id="EditSupplierDetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Update Buyer Details</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            document.title = "Buyer Master Details-";
            
            $("#buyer-list-details").DataTable({
                responsive: true,
                stateSave: true,
                ordering: false,
                pageLength: 15,
                ...
                buttons: [
                    'pageLength',
                    {
                        ...
                        text: '<i class="mdi mdi-layers-plus"></i> Add New Buyer',
                        className: 'cus-btn-primary',
                        action: function ( e, dt, node, config ) {
                            $('#addNewBuyerDetails').modal('show');
                        }
                    }
                ],
