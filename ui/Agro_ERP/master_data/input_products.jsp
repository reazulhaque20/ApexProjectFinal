    ...
    <%@include file="../header.jsp" %>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Farm Input Product Details List</h4>
                                </div>
                                <div class="card-body">
                                    <table id="inp-product-list-details" class="table cus-datatable table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>CODE</th>
                                                <th>CATEGORY NAME</th>
        ...
        <div id="addNewInpProductDetails" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-2">
                                ...
                                <select class="form-select form-control GlobalSelect" data-trigger name="division_name" required>
                                    ...
                                    <option value='26'>Kgs</option>
                                    <option value='27'>Pcs</option>
                                </select>
                            </div>
                            <div class="col-lg-12 mb-2">
    ...
    <script>
        $(document).ready(function () {
            document.title = "Input Products Master Details-";
            
            $("#inp-product-list-details").DataTable({
                responsive: true,
                stateSave: true,
                ordering: false,
                pageLength: 15,
                ...
                buttons: [
                    'pageLength',
                    {
                        ...
                        text: '<i class="mdi mdi-layers-plus"></i> Add New Input Product',
                        className: 'cus-btn-primary',
                        action: function ( e, dt, node, config ) {
                            $('#addNewInpProductDetails').modal('show');
                        }
                    }
                ],
