    ...
    <%@include file="../header.jsp" %>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Crop Grade Details List</h4>
                                </div>
                                <div class="card-body">
                                    <table id="crop-grade-list-details" class="table cus-datatable table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>CROP CODE</th>
                                                <th>CROP NAME</th>
        ...
        <div id="addNewCropGradeDetails" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myExtraLargeModalLabel">Add New Crop grade Details</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-2">
                                ...
                                <select class="form-select form-control GlobalSelect" data-trigger name="division_name" required>
                                    ...
                                    <option value='26'>Santana</option>
                                    <option value='27'>Apex</option>
                                </select>
                            </div>
                            <div class="col-lg-12 mb-2">
    ...
    <script>
        $(document).ready(function () {
            document.title = "Crop Grade Master Details-";
            
            $("#crop-grade-list-details").DataTable({
                responsive: true,
                stateSave: true,
                ordering: false,
                pageLength: 15,
                ...
                buttons: [
                    'pageLength',
                    {
                        ...
                        text: '<i class="mdi mdi-layers-plus"></i> Add New Crop Grade',
                        className: 'cus-btn-primary',
                        action: function ( e, dt, node, config ) {
                            $('#addNewCropGradeDetails').modal('show');
                        }
                    }
                ],
